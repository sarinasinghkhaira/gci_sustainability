...
# plot lines for all countries
  geom_line(alpha = 0.3, size = 1.5, lineend = "round", linejoin = "bevel") +
...
# add labels for 2008 rankings  
  geom_text(data = gci_rankings_top_10 %>% filter(year == 2007), 
...
# add labels for 2018 rankings  
  geom_text(data = gci_rankings_top_10 %>% filter(year == 2018), 
            aes(label = paste(gci_rank, country), x = 12.5), 
            hjust = 0, colour = "grey40", fontface = "bold", size = 3) +
  scale_x_discrete(breaks = 2007:2018, expand = c(.28, .1)) +
