...
ca_join %>%
  ...
  # geom_density_ridges(
  #      alpha = 0.7,  
  #      scale = .95, # prevents overlap between pillars
  #      rel_min_height = .01 #removes tails at 0
  # ) +
    stat_density_ridges(quantile_lines = TRUE, quantiles = 2, alpha = 0.6, scale = 0.95) +
    scale_fill_manual(values = c("#E04059", "#4F529C")) +
    scale_color_manual(values = c("#E04059", "#4F529C")) +
